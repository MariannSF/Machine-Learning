 ...
 */
public class PolicyIteration extends MDPSolver implements Planner, QProvider {

    protected Map<HashableState, Double> valueFunction;
    protected double maxDelta;
    protected int maxEvaluationIterations;
    protected int maxPolicyIteration;


    public PolicyIteration(SADomain domain,
                           double gamma,
                           HashableStateFactory hashingFactory,
                           ConstantValueFunction maxDelta,
                           int maxEvaluationIterations,
                           int maxPolicyIterations){
        this.solverInit(domain, gamma, hashingFactory);
        //this.maxDelta = maxDelta;
        this.maxEvaluationIterations = maxEvaluationIterations;
        this.maxPolicyIteration = maxPolicyIterations;
    ...
    public GreedyQPolicy planFromState(State initialState) {
        ...
        for(int i = 0; i < this.maxEvaluationIterations; i++){
    ...
    public void performReachabilityFrom(State seedState){
        ...
        for(HashableState hs : hashedStates){
            if(!this.valueFunction.containsKey(hs)){
                this.valueFunction.put(hs, this.maxDelta);
            }
        }
    ...
    public static void main(String [] args){
        ...
        gwd.setTf(new GridWorldTerminalFunction(4, 4));
        ...
        PolicyIteration pi = new PolicyIteration(domain, 0.99, new SimpleHashableStateFactory(), new ConstantValueFunction(0.01), 500, 500 );
